...
await flutterLocalNotificationsPlugin.zonedSchedule(          timeStr.hashCode,          'Hora de tomar ${med.name}',          'Dosagem: ${med.dosage}', tz.TZDateTime.from(         tz.TZDateTime.from(scheduledTime, tz.local), tz.local),          platformDetails,                    uiLocalNotificationDateInterpretation: tz.UILocalNotificationDateInterpretation.wallClockTime,          matchDateTimeComponents: DateTimeComponents.time      );
    }
  }
